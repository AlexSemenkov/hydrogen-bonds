...
public class GmxResidueTest extends GmxAbstractTest {
    ...
    public void testResidueCreation() {
        ...
        GmxResidue h2o = residueFactory.get(GmxResidueH2O.class, 100, water);
        Logger.log(h2o);
    ...
    public void testRotateWhile() {
        ...
        GmxResidue sol1 = residueFactory.get(GmxResidueH2O.class, 1, atoms1);
        GmxResidue sol2 = residueFactory.get(GmxResidueH2O.class, 2, atoms2);
        ...
        Logger.log("Cosine before rotation: " + hDon0.cosOfAngleBetweenTwoAtoms(oAcc0, oAcc1));
        Logger.log("Cosine before rotation: " + hDon1.cosOfAngleBetweenTwoAtoms(oAcc0, oAcc1));
        ...
        boolean result = sol2.rotateWhile(predicate0, predicate1);

        Logger.log("Cosine after rotation: " + hDon0.cosOfAngleBetweenTwoAtoms(oAcc0, oAcc1));
        Logger.log("Cosine after rotation: " + hDon1.cosOfAngleBetweenTwoAtoms(oAcc0, oAcc1));

        Assert.assertTrue(result, "Rotation failed.");
        Assert.assertTrue(Math.abs(hDon1.cosOfAngleBetweenTwoAtoms(oAcc0, oAcc1)) < 0.01, "Rotation failed.");
        Assert.assertTrue(Math.abs(hDon0.cosOfAngleBetweenTwoAtoms(oAcc0, oAcc1)) < 0.01, "Rotation failed.");
    ...
    public void testMoveTo() {
        ...
        GmxResidue h2o = residueFactory.get(GmxResidueH2O.class, 100, water);
        h2o.moveTo(new float[] { 1.f, 1.f, 1.f });
    ...
    public void testRotate() {
        ...
        GmxResidue h2o = residueFactory.get(GmxResidueH2O.class, 100, water);
        h2o.rotate(Math.PI / 2, Math.PI / 2, Math.PI / 2);
        verifyWaterCoordinates(h2o, //
    ...
    public void testRadiusVector() {
        ...
        h2o.moveTo(new float[] { 1.1f, 2.2f, 3.3f });
